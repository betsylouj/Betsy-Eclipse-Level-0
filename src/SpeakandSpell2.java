...
public class SpeakandSpell2 {
    ...
    speak("spell Mississippi");
    	String answer = JOptionPane.showInputDialog("Please spell the word");

        // 2. Catch the user's answer in a String
if (answer .equals("Mississippi"))
{
	speak("Correct");
	JOptionPane.showMessageDialog(null, "You are correct, well done!!");
}
else
{
	speak("Sorry that was wrong");
	JOptionPane.showMessageDialog(null, "Sorry, that was wrong - it is spelled Mississippi\nTry the next one");
}
